...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  filters: {
    moment: function moment(date) {
      return moment__WEBPACK_IMPORTED_MODULE_1___default.a.unix(date).format('MMMM Do YYYY');
    }
  },
  mounted: function mounted() {
    var _this = this;

    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('/api/items').then(function (response) {
      return _this.loaded = true, _this.items = response.data.data;
    });
  }
});
...
__webpack_require__(/*! /var/www/vhosts/funnies/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/vhosts/funnies/resources/sass/app.scss */"./resources/sass/app.scss");
